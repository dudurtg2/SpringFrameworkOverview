...
- [1. O que é Spring?](#1-o-que-é-spring)
  - [1.1. O problema](#11-the-problem)
  - [1.2. Solução Spring Boot](#12-spring-boot-solution)
  - [1.3. Spring Boot e Spring](#13-spring-boot-and-spring)
  - [1.4. Spring Boot Embedded Server](#14-spring-boot-embedded-server)
  - [1.5. Executando aplicativos Spring Boot](#15-running-spring-boot-apps)
  - [1.6. Implantando aplicativos Spring Boot](#16-deploying-spring-boot-apps)
  - [1.7. Perguntas gerais](#17-general-questions)
- [2. Inicialização Spring](#2-spring-initializr)
  - [2.1. start.spring.io](#21-startspringio)
  - [2.2. CLI do Spring Boot](#22-spring-boot-cli)
- [3. Controlador REST](#3-rest-controller)
- [4. Projetos Spring](#4-spring-projects)
- [5. Projetos Spring Boot](#5-spring-boot-projects)
  - [5.1. Estrutura de diretório padrão do Maven com Spring Boot](#51-maven-standard-directory-structure-with-spring-boot)
  - [5.2. Arquivos do wrapper do Maven](#52-maven-wrapper-files)
  - [5.3. Arquivo POM do Maven com Spring Boot](#53-maven-pom-file-with-spring-boot)
- [6. Iniciadores do Spring Boot](#6-spring-boot-starters)
...
- [8. Spring Boot Actuator](#8-spring-boot-actuator)
  ...
  - [8.2. Expondo Endpoints](#82-exposing-endpoints)
  - [8.3. Info Endpoint](#83-info-endpoint)
  - [8.4. Spring Boot Actuator Endpoints](#84-spring-boot-actuator-endpoints)
  - [8.5. Expondo Endpoints](#85-exposing-endpoints)
  - [8.6. Obter uma lista de beans](#86-get-a-list-of-beans)
  - [8.7. Processo de desenvolvimento](#87-development-process)
  - [8.8. Segurança](#88-security)
  - [8.8.1. Endpoints protegidos](#881-secured-endpoints)
  - [8.9. Excluindo endpoints](#89-excluding-endpoints)
  - [8.9.1. Processo de desenvolvimento](#891-development-process)
  - [8.10. Exemplo de atuador](#810-actuator-example)
- [9. Propriedades do aplicativo personalizado](#9-custom-application-properties)
  - [9.1. Processo de desenvolvimento](#91-development-process)
  - [9.2. Propriedades do Spring Boot](#92-spring-boot-properties)
    - [9.2.1. Propriedades do núcleo](#921-core-properties)
    - [9.2.2. Propriedades da Web](#922-web-properties)
    - [9.2.3. Propriedades do atuador](#923-actuator-properties)
    - [9.2.4. Propriedades de segurança](#924-security-properties)
    - [9.2.5. Propriedades de dados](#925-data-properties)
- [10. Inversão de controle e injeção de dependência](#10-inversion-of-control-and-dependency-injection)
  - [10.1. Tipos de injeção](#101-injection-types)
    - [10.1.1. Tipos de injeção - Qual usar?](#1011-injection-types---which-one-to-use)
    - [10.1.2. O que é Spring AutoWiring](#1012-what-is-spring-autowiring)
  - [10.2. Exemplo de Autowiring](#102-autowiring-example)
  - [10.3. Exemplo de aplicativo](#103-example-application)
  - [10.4. Processo de desenvolvimento - Injeção de construtor](#104-development-process---constructor-injection)
  - [10.5. Spring para aplicativos corporativos](#105-spring-for-enterprise-applications)
  - [10.6. Procurando classes de componentes](#106-scanning-for-component-classes)
  - [10.7. Anotações](#107-annotations)
  - [10.8. Mais sobre a varredura de componentes](#108-more-on-component-scanning)
  - [10.9. Injeção de Setter](#109-setter-injection)
  - [10.10. @Primary anotação](#1010-primary-annotation)
    - [10.10.1. Solução alternativa](#10101-alternate-solution)
    - [10.10.2. @Primary - Apenas um](#10102-primary---only-one)
    - [10.10.3. Qual: @Primary ou @Qualifier?](#10103-which-one-primary-or-qualifier)
  - [10.11. Inicialização lenta](#1011-lazy-initialization)
    - [10.11.1. Inicialização lenta](#10111-lazy-initialization)
    - [10.11.2. Vantagens e desvantagens](#10112-vantagens-e-desvantagens)
  - [10.12. Escopos do Bean](#1012-bean-scopes)
    - [10.12.1. Escopo padrão](#10121-default-scope)
  - [10.13. Escopos adicionais do Spring Bean](#1013-additional-spring-bean-scopes)
  - [10.14. Métodos do ciclo de vida do Bean - Anotações](#1014-bean-lifecycle-methods---annotations)
- [11. Comandos - Executar a partir da linha de comando](#11-comandos---executar-a-partir-da-linha-de-comando)
  - [11.1. Comandos do Maven](#111-maven-comandos)
  - [11.2. Comandos de primavera](#112-spring-commands)
